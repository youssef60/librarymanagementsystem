 ...
 * @author MHD
 */
public class JournalModel extends Doc {
    ...
    public JournalModel(int idJournal,  String titre, String nomAuteur, int nbCopie, String datePublication,String issn, int idCat) {
